...
import (
	...
	apisv1alpha1 "github.com/RicochetStudios/polaris/apis/v1alpha1"
	versioned "github.com/RicochetStudios/polaris/pkg/client/clientset/versioned"
	internalinterfaces "github.com/RicochetStudios/polaris/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/RicochetStudios/polaris/pkg/client/listers/apis/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolarisV1alpha1().Servers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolarisV1alpha1().Servers(namespace).Watch(context.TODO(), options)
			},
		},
		&apisv1alpha1.Server{},
		resyncPeriod,
...
func (f *serverInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha1.Server{}, f.defaultInformer)
}
