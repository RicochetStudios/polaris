...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/RicochetStudios/polaris/apis/v1alpha1.ServerSpec":    schema_RicochetStudios_polaris_apis_v1alpha1_ServerSpec(ref),
		"github.com/RicochetStudios/polaris/apis/v1alpha1.ServerStatus":  schema_RicochetStudios_polaris_apis_v1alpha1_ServerStatus(ref),
...
func schema_RicochetStudios_polaris_apis_v1alpha1_Game(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Game defines the game and modloader to be used for the server.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"modLoader": {
						SchemaProps: spec.SchemaProps{
							Description: "The software used to load mods into the game server. Vanilla will launch the game server as default without any mods.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_RicochetStudios_polaris_apis_v1alpha1_Network(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Network defines the network configuration for the server.\n\nThis defines how the user can connect to the server.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
					...
					"labels": {
						SchemaProps: spec.SchemaProps{
							Description: "Map of string keys and values which select the gateway to use for this server.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
...
func schema_RicochetStudios_polaris_apis_v1alpha1_Server(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/RicochetStudios/polaris/apis/v1alpha1.ServerSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/RicochetStudios/polaris/apis/v1alpha1.ServerStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/RicochetStudios/polaris/apis/v1alpha1.ServerSpec", "github.com/RicochetStudios/polaris/apis/v1alpha1.ServerStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_RicochetStudios_polaris_apis_v1alpha1_ServerList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServerList contains a list of Server",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/RicochetStudios/polaris/apis/v1alpha1.Server"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/RicochetStudios/polaris/apis/v1alpha1.Server", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_RicochetStudios_polaris_apis_v1alpha1_ServerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"size": {
						SchemaProps: spec.SchemaProps{
							Description: "This changes the resources given to the server and the player limit. Valid values are: xs, s, m, l, xl",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"game": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/RicochetStudios/polaris/apis/v1alpha1.Game"),
						},
					},
					"network": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/RicochetStudios/polaris/apis/v1alpha1.Network"),
						},
					},
				},
				Required: []string{"id", "game"},
			},
		},
		Dependencies: []string{
			"github.com/RicochetStudios/polaris/apis/v1alpha1.Game", "github.com/RicochetStudios/polaris/apis/v1alpha1.Network"},
	}
}

func schema_RicochetStudios_polaris_apis_v1alpha1_ServerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
