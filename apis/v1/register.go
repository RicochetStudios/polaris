...
// Package v1 contains API Schema definitions for the polaris v1 API group
...
func init() {
	...
	if err := AddToScheme(GlobalScheme); err != nil {
		panic(fmt.Sprintf("failed to add polaris scheme: %s", err))
	}
}

// Adds the list of known types to api.Scheme.
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(SchemeGroupVersion, &Polaris{}, &PolarisList{})
